...
public class CodefDailyMissionTasklet implements Tasklet {
    ...
    /**
     * CODEF_DAILY 미션 자동 검증을 수행하는 배치 step의 실행 로직
     **/
    @Override
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {

        log.info("✅ CODEF_DAILY 미션 자동 검증 시작");
        ...
        for (Long userId : userIds) {
            ...
            for (Integer missionId : missionIds) {
                ...
                if(missionType.equals("CODEF_DAILY")) {
