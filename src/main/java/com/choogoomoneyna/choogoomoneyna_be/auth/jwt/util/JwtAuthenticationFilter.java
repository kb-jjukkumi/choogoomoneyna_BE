    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if (bearerToken == null || !bearerToken.startsWith(BEARER_PREFIX)) {
                ...
                throw new CustomException(ResponseCode.AUTH_TOKEN_INVALID, "Invalid bearer token");
            }
            ...
            if (!jwtTokenProvider.validateToken(token)) {
                throw new CustomException(ResponseCode.AUTH_TOKEN_INVALID, "Invalid or expired token");
            }
